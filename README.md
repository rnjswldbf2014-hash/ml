...
| `[128,256,256]` | 1024 | 19.2 ms | **16.0 ms** | GPU 1.19배 |
| `[512,1024,1024]` | 256 | 48.4 ms | **29.4 ms** | GPU 1.65배 |
| `[512,1024,1024]` | 1024 | 174.2 ms | **87.6 ms** | GPU 1.99배 |
| `[1024,2048,2048]` | 512 | 335.8 ms | **137.5 ms** | GPU 2.44배 |

작은 묶음에서는 여전히 CPU 가 낫습니다. 배치 1 온라인 학습에는 GPU 가 아예 개입하지
않습니다 — 디스패치 비용이 계산보다 크기 때문입니다.
